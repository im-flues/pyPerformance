...
shift_timings = [
    {"NAME": "Dez", "USERNAME": "THDEZ", "START_TIME": "7:00 AM", "END_TIME": "3:30 PM", "SHIFT": "Shift 1"},
    {"NAME": "Devlin ", "USERNAME": "THDEV", "START_TIME": "7:00 AM", "END_TIME": "3:30 PM", "SHIFT": "Shift 1"},
    {"NAME": "Angie", "USERNAME": "TH ANGIE", "START_TIME": "8:00 AM", "END_TIME": "4:30 PM", "SHIFT": "Shift 2"},
    {"NAME": "Linden", "USERNAME": "THLINDEN", "START_TIME": "8:00 AM", "END_TIME": "4:30 PM", "SHIFT": "Shift 2"},
...
def fetch_performance_data():
    try:
        ...
        metrics = df.groupby('NAME').agg({
            ...
            'Qty': 'count',  # Count of pick actions
            'START_TIME': 'first',
            'END_TIME': 'first',
            'SHIFT': 'first'
        }).reset_index()
        ...
        metrics['AvgTimeDiff'] = metrics['AvgTimeDiff'].round(2)
        metrics['MedianTimeDiff'] = metrics['MedianTimeDiff'].round(2)
...
if __name__ == '__main__':
    ...
    app.run(debug=debug_mode, port=6060)
